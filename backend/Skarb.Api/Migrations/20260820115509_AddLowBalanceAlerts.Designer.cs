...
namespace Skarb.Api.Migrations
{
    ...
    [Migration("20260820115509_AddLowBalanceAlerts")]
    partial class AddLowBalanceAlerts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Skarb.Api.Common.Domain.Account", b =>
                {
                    ...
                    b.Property<string>("LowBalanceChatId")
                        .HasColumnType("text");

                    b.Property<DateTime?>("LowBalanceNotifiedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Skarb.Api.Common.Domain.NotificationSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
